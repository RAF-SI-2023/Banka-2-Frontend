// src/app/components/acquired-securities-info-dialog/acquired-securities-info-dialog.component.ts
...
export class AcquiredSecuritiesInfoDialogComponent {
  ...
  updateSecurity(): void {
    if (this.form.valid) {
      ...
      if(updatedQuantity<= this.data.quantity-this.data.reservedQuantity)
      {
