...
@Component({
	...
	templateUrl: './transactions-all-info-dialog.component.html',
	styleUrls: ['./transactions-all-info-dialog.component.css'],
})
export class TransactionsAllInfoDialogComponent {
